...
from auto_seq_utils import get_entities, filter_invalid
...
class Predictor:
    def __init__(self, model_path, labels, max_seq_length, multi_head=False):
        ...
        # load model
        model_cls = BertForMultiHeadTokenClassification if multi_head else AutoModelForTokenClassification
        self.model = model_cls.from_pretrained(model_path, num_labels=len(labels) - 1)
